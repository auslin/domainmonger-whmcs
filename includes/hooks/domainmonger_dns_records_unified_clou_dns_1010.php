<?php
/**
 * DomainMonger patch 1010: Unified DNS Records table.
 *
...
add_hook('ClientAreaFooterOutput', 1001, function ($vars) {
    ...
    // Keep this older unified renderer available only for intentional fallback testing.
    if (!isset($_GET['dmlegacydns']) && !isset($_GET['dmnoredirect'])) {
        return '';
    }
    ...
    return <<<HTML
<style id="dm-dns-records-unified-1010-style">
...
<script id="dm-dns-records-unified-1010-script">
(function () {
