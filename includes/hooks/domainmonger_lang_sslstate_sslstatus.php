<?php
/**
 * DomainMonger WHMCS language cleanup: sslState.sslStatus.
 *
...
if (!function_exists('dm_sslstate_sslstatus_apply_language_value_693')) {
    function dm_sslstate_sslstatus_apply_language_value_693($vars = [])
    {
        global $_LANG;
        ...
        $templateLang['sslState']['sslStatus'] = 'SSL Status';
        $templateLang['sslState.sslStatus'] = 'SSL Status';
...
add_hook('ClientAreaPage', 1, function ($vars) {
    return dm_sslstate_sslstatus_apply_language_value_693($vars);
});

add_hook('ClientAreaHeadOutput', 1, function ($vars) {
    dm_sslstate_sslstatus_apply_language_value_693($vars);
...
(function () {
    ...
    var rawKey = 'sslState.sslStatus';
    var replacement = 'SSL Status';
