...
{elseif $cloudAction eq 'zone-transfers'}
	{include file="$path/zone-transfers.tpl"}

{elseif $cloudAction eq 'parked-templates'}
	{include file="$path/parked-templates.tpl"}

{elseif $cloudAction eq 'export-zone-file'}
	{include file="$path/export-zone-file.tpl"}

{elseif $cloudAction eq 'free-ssl'}
	{include file="$path/free-ssl.tpl"}

{elseif $cloudAction eq 'copy-zone'}
	{include file="$path/copy-zone.tpl"}
