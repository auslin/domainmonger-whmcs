...
<form method="post" class="fo-form from-inline cloudns-body-panel cloudns-dnssec-panel" action="clientarea.php?action=productdetails&id={$serviceid}&customAction=dnssec-deactivate&zone={$zone}">
	
	<div class="cloudns-page-status">Status: <strong>Active</strong></div>
	<h4><strong>DS Records:</strong></h4>
	<div class = "table-responsive cloudns-table-shell">
	<table class="table table-hover dnssec-ds cloudns-rounded-table">
	...
	<br class='clear'>
	<div class = "table-responsive cloudns-table-shell">
	<table class="table table-hover dataTable no-footer dtr-inline cloudns-rounded-table">
		<thead>
			<tr>
	...
	<div class = "table-responsive cloudns-table-shell">
	<table class="table table-hover dataTable no-footer dtr-inline cloudns-rounded-table" cellspacing="0" width="100%" id='dnskey'>
		<tbody>
	...
	<br class="clear">
	<input type="submit" name="deactivate_dnssec" id="activate_dnssec" value="Deactivate" class="btn cloudns-switch-style-button cloudns-btn-danger" />
</form>