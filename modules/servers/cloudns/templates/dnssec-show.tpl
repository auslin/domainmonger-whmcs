...
<form method="post" class="fo-form from-inline cloudns-body-panel cloudns-dnssec-panel" action="clientarea.php?action=productdetails&id={$serviceid}&customAction=dnssec-activate&zone={$zone}">
	
	<div class="cloudns-page-status">Status: <strong>Inactive</strong></div>
	...
	<br class="clear">
	<input type="submit" name="activate_dnssec" id="activate_dnssec" value="Activate DNSSEC" class="btn cloudns-switch-style-button cloudns-btn-primary" />
</form>