...
<div class="cloudns-body-panel cloudns-import-panel">
<form action="clientarea.php?action=productdetails&id={$serviceid}&customAction=import-records&zone={$zone}" method="post" class="importForm">
	<table class="table-bordered table import-table cloudns-rounded-table">
		<thead>
			<tr>
				<th colspan="2">Paste Zone File Records Here</th>
			</tr>
		</thead>
		...
		<tbody>
			...
			<tr>
				<th>Action:</th>
				<td>
					<label><input class="pull-left" title="The current records of the zone will be replaced by the new ones" type="checkbox" name="delete" value="1" />&nbsp; Delete Existing Records</label>
				</td>
			</tr>
			<tr>
				<th>Records:</th>
		...
		<tfoot>
			<tr>
				<td colspan="2" class="text-right">
					<input type="submit" class="btn cloudns-switch-style-button cloudns-btn-primary" value="Import Records">
				</td>
			</tr>
		</tfoot>
	</table>
