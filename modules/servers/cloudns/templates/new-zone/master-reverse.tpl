...
<div class="newZoneContainer cloudns-add-zone-type-panel">
	<form action="clientarea.php?action=productdetails&id={$serviceid}&customAction=add-zone" method="post" class="recordsForm">
		...
		<input type="hidden" name="newZoneOptions" value="1" />
		<div class="cloudns-auto-ns-note">The required DomainMonger nameservers will be added automatically.</div>
		<br clear="all" />
			...
			<br class="mButton">
			<input type="submit" value="Create" class="btn cloudns-switch-style-button cloudns-btn-primary" />
