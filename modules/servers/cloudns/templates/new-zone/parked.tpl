...
<div class="newZoneContainer cloudns-add-zone-type-panel">
	<form action="clientarea.php?action=productdetails&id={$serviceid}&customAction=add-zone" method="post">
		<h4>Parked Zone</h4>
		<div class="cloudns-parked-zone-note">
			Create this domain as a Parked Zone. After it is created, you can apply a parked template from Advanced &rarr; Parked Templates.
		</div>
		<span class="pull-left">Domain name: &nbsp; </span>
		<input class="pull-left" type="text" name="zone" id="parkedZoneDomain" />
		<input type="hidden" name="zoneType" value="parkedZoneType" />
		<input type="submit" name="" value="Create" class="btn cloudns-switch-style-button cloudns-btn-primary" />
	</form>
</div>
