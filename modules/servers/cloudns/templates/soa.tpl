...
<div class="cloudns-body-panel cloudns-soa-panel">
	...
	<table class="table cloudns-rounded-table">
		...
		<tr>
			<th></th>
			<td>
				<input type="submit" class="btn cloudns-switch-style-button cloudns-btn-primary" name="do_save" value="Save" /> 
				<input type="submit" class="btn cloudns-switch-style-button cloudns-btn-secondary" name="do_reset" value="Reset" />
			</td>
		</tr>
	</table>
</form>
