...
<link rel="stylesheet" type="text/css" href="{$WEB_ROOT}/templates/orderforms/standard_cart/css/dm-domain-renewals-v96.css?v=97" />

<div id="order-standard_cart">
    <div class="row dm-renew-three-col-layout dm-renew-layout-v94">
        <div class="col-md-3 dm-renew-left-sidebar sidebar">
            {include file="orderforms/standard_cart/sidebar-categories.tpl"}
        </div>

        <div class="col-md-6 dm-renew-main-column">
            ...
            <div class="dm-renew-mobile-sidebar-only">
                {include file="orderforms/standard_cart/sidebar-categories-collapsed.tpl"}
            </div>

            <div class="row dm-renew-main-row">

                <div class="col-md-12 dm-renew-list-wrap">
        ...
        <div class="dm-renew-right-summary" id="scrollingPanelContainer">
            <div id="orderSummary">
                <div class="order-summary dm-renew-order-summary">
                    <div class="loader" id="orderSummaryLoader">
                        <i class="fas fa-fw fa-sync fa-spin"></i>
                    </div>
                    <h2 class="dm-renew-order-summary-title">{lang key='ordersummary'}</h2>
                    <div class="summary-container dm-renew-summary-container" id="producttotal"></div>
                </div>
                <div class="text-center dm-renew-cart-button-wrap">
