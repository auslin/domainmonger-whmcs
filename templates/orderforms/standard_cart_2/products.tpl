                        ...
                        <div class="col-md-6">
                            <div class="product clearfix" id="product{$product@iteration}">
                                ...
                                <footer>
                                    ...
                                    <a href="{$product.productUrl|default:"cart.php?a=add&pid={$product.pid}"}" class="btn btn-success btn-sm btn-order-now" id="{$idPrefix}-order-button"{if $product.hasRecommendations} data-has-recommendations="1"{/if}>
