...
<div class="card dm-contact-selector-card">
    <div class="card-header dm-contact-card-header">
        <h3 class="card-title">{lang key='clientareachoosecontact'}</h3>
    </div>
    <div class="card-body">
        <form role="form" method="post" action="{routePath('account-contacts')}" class="dm-contact-selector-form">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 mt-2 mt-md-0">
                    <button type="submit" class="btn btn-default btn-block dm-contact-go-btn">{lang key='go'}</button>
                </div>
            </div>
        </form>
    </div>
...
<form role="form" method="post" action="{routePath('account-contacts-save')}" class="dm-contact-manage-form">
    <input type="hidden" name="contactid" value="{$contactid}" />

    <div class="card dm-contact-details-card">
        <div class="card-header dm-contact-card-header">
    ...
    <div class="card dm-contact-email-card">
        <div class="card-header dm-contact-card-header">
            <h3 class="card-title">{lang key='clientareacontactsemails'}</h3>
        </div>

        <div class="card-body">
            <div class="controls form-check dm-contact-email-preferences">
