...
{literal}
<style id="dm-domains-table-header-page-351">
/* DM Patch 351: page-specific Domains table header cleanup.
   This lives in clientareadomains.tpl so it is later/more specific than global header CSS. */
body.whmcsbody #main-body #tableDomainsList thead th,
body.whmcsbody #main-body #tableDomainsList thead th.sorting,
body.whmcsbody #main-body #tableDomainsList thead th.sorting_asc,
body.whmcsbody #main-body #tableDomainsList thead th.sorting_desc,
body.whmcsbody #main-body #tableDomainsList thead th.sorting_asc_disabled,
body.whmcsbody #main-body #tableDomainsList thead th.sorting_desc_disabled {
...
body.whmcsbody #main-body #tableDomainsList thead th *,
body.whmcsbody #main-body #tableDomainsList thead th a,
body.whmcsbody #main-body #tableDomainsList thead th span,
body.whmcsbody #main-body #tableDomainsList thead th div {
    background: transparent !important;
    background-color: transparent !important;
    color: #fff !important;
}

body.whmcsbody #main-body #tableDomainsList thead th:before,
body.whmcsbody #main-body #tableDomainsList thead th:after {
    color: #dbe7f2 !important;
    opacity: .85 !important;
}
</style>

<script id="dm-domains-table-header-page-351-js">
jQuery(function ($) {
    function dmDomainMongerNormalizeDomainsHeader() {
        var $headers = $('#tableDomainsList thead th');
    ...
    dmDomainMongerNormalizeDomainsHeader();

    setTimeout(dmDomainMongerNormalizeDomainsHeader, 100);
    setTimeout(dmDomainMongerNormalizeDomainsHeader, 500);

    $('#tableDomainsList').on('draw.dt order.dt column-sizing.dt responsive-display.dt', function () {
        dmDomainMongerNormalizeDomainsHeader();
        setTimeout(dmDomainMongerNormalizeDomainsHeader, 50);
    });
});
</script>
{/literal}
