...
jQuery(document).ready(function($){
    function dmRcActivateContactChangeTab(hash) {
    ...
    $('a[href^="#tab"]').on('click', function(e) {
        ...
        e.preventDefault();
        dmRcActivateContactChangeTab(hash);
        $('a[href^="#tab"]').removeClass('active');
        $(this).addClass('active');
    });

    if (window.location.hash && $(window.location.hash).length) {
        dmRcActivateContactChangeTab(window.location.hash);
    } else {
...
<div class="tab-content margin-bottom">
    <div class="tab-pane fade show in active" id="tabModify">
