<style>
.dm-rc-email-page .dm-rc-email-page-heading {
    background: #163a5f;
    color: #fff;
    font-size: 18px;
    font-weight: 700;
...
<div class="dm-rc-email-page-heading">Email Forwarding</div>
...
<table class="table table-bordered table-hover">
	...
	{* Start: Catchall account for FREE Email accounts and Mail forwarding only setup *}
	<tr>
		<td>
	...
	{* End: Catchall account for FREE Email accounts and Mail forwarding only setup *}	
	...
	<tr>
		<td>
			<strong>Additional Storage Blocks</strong>
		</td>
		<td colspan="2">Total Additional Storage Blocks: <span class="label label-info">{$total_storageblocks}</span> - Unused Additional Storage Blocks: <span class="label label-default">{$unused_storageblocks}</span></td>
	</tr>
	{/if}
</table>
