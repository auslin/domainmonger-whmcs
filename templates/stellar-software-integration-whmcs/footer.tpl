			...
			{* </div> Commented out to fix WHMCS bug *}
	...
	{include file="$template/integration/integration-content-bottom.html"}
    
    {include file="$template/integration/integration-footer.html"}
