{if ($linkableProviders || $hasLinkedProvidersEnabled) && $linkContext == 'linktable'}
    <div class="dm-linked-accounts-table-wrap">
        <table id="tableLinkedAccounts" class="table display data-driven dm-linked-accounts-table"
...
{elseif $linkableProviders}
    ...
    {elseif $linkContext == 'clientsecurity'}
        <p class="dm-linked-accounts-intro">{lang key='remoteAuthn.mayHaveMultipleLinks'}</p>
    {/if}

    <div class="providerPreLinking dm-provider-prelinking" data-link-context="{$linkContext}"
