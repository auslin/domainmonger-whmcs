...
<div class="table-container clearfix">
    <table id="tableSslList" class="table table-list">
        <thead>
            <tr>
                <th><span class="dm-ssl-th-label">{lang key='ssldomain'}</span><span class="dm-ssl-sort-stack" aria-hidden="true"><span class="dm-ssl-sort-up"></span><span class="dm-ssl-sort-down"></span></span></th>
                <th><span class="dm-ssl-th-label">{lang key='sslproduct'}</span><span class="dm-ssl-sort-stack" aria-hidden="true"><span class="dm-ssl-sort-up"></span><span class="dm-ssl-sort-down"></span></span></th>
                <th><span class="dm-ssl-th-label">{lang key='sslorderdate'}</span><span class="dm-ssl-sort-stack" aria-hidden="true"><span class="dm-ssl-sort-up"></span><span class="dm-ssl-sort-down"></span></span></th>
                <th><span class="dm-ssl-th-label">{lang key='sslrenewaldate'}</span><span class="dm-ssl-sort-stack" aria-hidden="true"><span class="dm-ssl-sort-up"></span><span class="dm-ssl-sort-down"></span></span></th>
                <th><span class="dm-ssl-th-label">{lang key='actions'}</span></th>
            </tr>
        </thead>
        <tbody>
