<link rel="stylesheet" href="{$WEB_ROOT}/templates/{$template}/css/dm-whmcs-submit-ticket-editor-v1.css?v=1">

<form method="post" action="{$smarty.server.PHP_SELF}?step=3" enctype="multipart/form-data" role="form" class="dm-submit-ticket-form">
